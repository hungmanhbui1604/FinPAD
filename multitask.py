...
if __name__ == '__main__':
    ...
    wandb.init(
        project="FinPAD",
        name=f"multitask_{config['BACKBONE_NAME']}_{config['YEAR']}_{config['TRAIN_SENSOR']}_{config['TEST_SENSOR']}",
        config=config,
    ...
    for epoch in range(config['NUM_EPOCHS']):
        ...
        train_metrics = train_one_epoch(model, train_loader, spoof_criterion, material_criterion, optimizer, device, config)
        val_metrics = validate_one_epoch(model, val_loader, spoof_criterion, material_criterion, device, config)
